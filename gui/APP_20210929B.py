...
from lib.DobotFunction.Camera import DeviceNameToNum, WebCam_OnOff, Snapshot, scale_box, Preview, Color_cvt, SnapshotCvt
...
class Dobot_APP:
    ...
    def ContoursBtn(self, cam: cv2.VideoCapture, values: list, drawing: bool = True):
